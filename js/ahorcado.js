...
var endgame = false
var acertados = 0
var listaPalabras = ["css", "python", "cariño", "universo", "salir", "veloz", 
                    "pasion", "audaz", "abrazo", "ficcion", "hueso", "amor", 
                    "cero", "curacion", "genetico", "pintar", "capaz"];
...
function gameOver() {
    if(document.querySelector(".state-nodisplay") != null){
        ...
        game.textContent = "Has";

        const over = document.createElement("div");
        over.textContent = "Perdido";
...
function drawGame() {
    ...
    if (window.modoOscuro == false) {
        pincel.strokeStyle = rs.getPropertyValue('--dibujo_color');
    }
    else {
        pincel.strokeStyle = rs.getPropertyValue('--dibujo_color');
    }
